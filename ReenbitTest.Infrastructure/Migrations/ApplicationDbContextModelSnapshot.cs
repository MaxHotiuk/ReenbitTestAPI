...
namespace ReenbitTest.Infrastructure.Migrations
{
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReenbitTest.Core.Entities.ChatRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReenbitTest.Core.Entities.ChatRoomUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ReenbitTest.Core.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReenbitTest.Core.Entities.ChatRoomUser", b =>
                {
                    b.HasOne("ReenbitTest.Core.Entities.ChatRoom", "ChatRoom")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("ReenbitTest.Core.Entities.Message", b =>
                {
                    ...
                    b.HasOne("ReenbitTest.Core.Entities.ApplicationUser", "Sender")
                        .WithMany("Messages")
